...
public class Node extends NodeParent implements TransformProvider {
    ...
    public LightInstance getLightInstance(){
        return lightInstance;
    }

//    public ArrayList<LightInstance> getLightInstances(){
//        Renderer renderer = getRendererOrDie();
//
//        return renderer.getLightInstances();
//    }
...
//        destroyLightInstance();
    ...
    public void destroyLightInstance() {
    ...
    public int getLightInstancesSize(){
        return getRendererOrDie().getLightInstancesSize();
    }
    public void destroyLightInstanceLast() {
        LightInstance lightInstance = getRendererOrDie().getLastLightInstance();
