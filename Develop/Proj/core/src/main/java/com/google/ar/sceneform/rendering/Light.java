...
//  public static Builder builder(com.google.ar.sceneform.samples.gltf.MainActivity mainActivity, Type type) {
//    AndroidPreconditions.checkMinAndroidApiLevel();
//    return new Builder(type);
//  }
  public static Builder builder(Context context, Type type) {
    AndroidPreconditions.checkMinAndroidApiLevel();
    return new Builder(type);
  }
